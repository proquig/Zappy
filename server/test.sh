...
echo "TEST 1"
if [ -z $3 ]; then
   ./zappy_server -p 4242 -x $1 -y $2 -n toto titi -c 10 -t 10
else
    valgrind ./zappy_server -p 4242 -x $1 -y $2 -n toto titi -c 10 -t 10 & #2>toto &
fi
echo "TEST 1"
make clean
...
i=0
while [ $i -lt $3 ]; do
    ../client/zappy_ai toto 4242 0 > /dev/null 2>&1 &
    i=$[$i+1]
done
